...
/*
returnt he value of a roman numbers
*/
...
/*
return True if the symbols exist
*/
...
//type the Latin number
type windowedRoman string
/*
create the symbol of the Latin number
*/
...
/*
return True if symbol can be the subtrhaend
*/
